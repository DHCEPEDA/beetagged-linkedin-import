  ...
  res.send(`
    ...
    <body>
      ...
      <div class="box">
        ...
        <p><a href="/facebook" class="button">Facebook Login Test</a></p>
        <p><a href="/linkedin" class="button">LinkedIn Login Test</a></p>
      </div>
    ...
    <body>
      ...
      <script>
        document.getElementById('fbLogin').addEventListener('click', function() {
          ...
          const fbLoginUrl = 'https://www.facebook.com/v10.0/dialog/oauth?client_id=' + appId + 
    ...
    <body>
      ...
      <script>
        document.getElementById('liLogin').addEventListener('click', function() {
          ...
          const liLoginUrl = 'https://www.linkedin.com/oauth/v2/authorization?response_type=code' + 
                            '&client_id=' + clientId + 
                            '&redirect_uri=' + encodeURIComponent(redirectUri) + 
                            '&state=' + state + 
                            '&scope=' + scope;
